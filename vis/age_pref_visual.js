...
d3.selectAll(".heatMapRect")
  ...
  heatmapSvg.selectAll(".heatMapRect")
    ...
    .attr("x", gridSize * 13)
    .attr("y", 300-10+(gridSize-gridSpacing)/2)
    .text("less")
  ...
  if(!isFemale){ // call out note
      ...
      .attr("x", gridSize*3.5)
      .attr("y", gridSize*9.5)
      .text("24% of men ages 25 and older say")
      .style("font-family", "Inconsolata")
      .style("font-weight", "bold")
          .style("font-size", "12px");
      heatmapSvg.append("text")
      ...
      heatmapSvg.append("line")
      .attr("class", "heatmap_notes")
      .attr("x1", gridSize*6+2)
      .attr("x2", gridSize*7 - gridSpacing - 2)
      .attr("y1", gridSize*7)
      .attr("y2", gridSize*7)
      .style("stroke", darkTextColor)
      .style("stroke-width", 2);
      ...
      heatmapSvg.append("path")
      .attr("class", "heatmap_notes")
      .attr("d", "M " + (gridSize*6 + gridSize*7 - gridSpacing)/2 + " " + (gridSize*7 + 5)
          + "L " + (gridSize*6 + gridSize*7 - gridSpacing)/2 + " " + (gridSize*9.5)
          + "L" + (gridSize*5.7) + " " + (gridSize*9.5))
      .style("stroke", darkTextColor)
      .style("stroke-width", 2)
      .style("fill", "none");          
      heatmapSvg.append("text")
      ...
      .attr("x", -gridSize)
      .attr("y", gridSize*9.5)
      .text("Just 52% of 24-year old women said")
      .style("font-family", "Inconsolata")
      .style("font-weight", "bold")
          .style("font-size", "12px");
      heatmapSvg.append("text")
      ...
      .attr("x", -gridSize)
      .attr("y", gridSize*9.5 + 15)
      .text("they would date someone age 23.")
      .style("font-family", "Inconsolata")
      .style("font-weight", "bold")
          .style("font-size", "12px");
      heatmapSvg.append("text")
      ...
      .text("Ladies, that is only a 1 year difference!")
      .style("font-family", "Inconsolata")
      .style("font-weight", "bold")
      .style("font-size", "12px");
  }
